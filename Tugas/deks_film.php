...
$type = isset($_GET['type']) && $_GET['type'] === 'coming' ? 'film_coming' : 'film';

$result = $koneksi->query("SELECT * FROM $type WHERE id=$id");
    ...
    <div class="details">
      ...
      <div class="buttons">
        <?php if (!empty($embed_url)): ?>
          <a href="#trailerModal">View Trailer</a>
        <?php endif; ?>
        <a href="ticket.php?id=<?= $film['id']; ?>">Watch Now</a>
      </div>
    </div>
  </div>
