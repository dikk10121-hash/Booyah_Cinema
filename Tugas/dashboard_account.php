...
// Ambil semua data account dari tabel user (misalnya tabelnya bernama 'users')
        ...
        <tbody>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>{$row['password']}</td>
                    <td>
                      <a href='dashboard_account_edit.php?id={$row['id']}' class='btn-edit'>Edit</a>
                      <a href='dashboard_account_delete.php?id={$row['id']}' class='btn-delete' onclick=\"return confirm('Yakin hapus akun ini?');\">Delete</a>
                    </td>
                  </tr>";
            $no++;
          }
